    ...
    : QWidget(parent)
{
    ...
    editor_paper_bg_color_ = QColor(54, 54, 54);
...
void QtDrawingPaperEditor::DrawPaper(QPainter& painter) {
    ...
    */
    ...
    //ÉèÖÃÍ¼Æ¬
    QImage m_image("D:\\vsworkplace\\flann\\flann\\output4\\1-out2.bmp");
    QPixmap pixmap1 = QPixmap::fromImage(m_image).scaled(QSize(draw_width, draw_height), Qt::IgnoreAspectRatio);
    painter.drawPixmap(start_x, start_y, pixmap1);
